...
{
    internal class EventExists : Condition
    {
        #region Fields
        ...
        internal EventExists(string description, int eventId) 
            : base(description) {
            
            Init(eventId);
        }

        internal EventExists(int id, string description, int eventId, bool isClone)
        ...
        public override bool IsTrue(IRule parentRule) {
            if (parentRule != null) {
                if (EventNS.EventRegistry.HasEvent(this.EventId)) {
                    return true;
                }
            }
        ...
        public override ICondition Clone(IGame cloneGame) { // [TODO] should be IGame interface
            return new EventExists(this.Id, this.Description, this.EventId, true);
        }
